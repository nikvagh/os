...
class MedicineController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('medicine_list')->with($data);
    }

    public function load_more_medicine(Request $request){
        ...
        if($if_data == "Y"){
            return view('medicine_list_block')->with($data);
        }else{
            return '';
        }
    }
    ...
    public function medicine_details(Request $request){
        ...
        $client = new \GuzzleHttp\Client(['verify' => config('constants.Guzzle.ssl')]);
        $response = $client->post(config('constants.API_ROOT').'api/v1/medicines/get', [
                'form_params' => [
        ...
        // print_r($data);
        // echo "</pre>";
        return view('medicine_detail')->with($data);
    }
