...
//                    }
    ...
    public function setAdditionalInfo(array $info)
    {
        ...
        $this->data['address_id'] = (isset($info['address_id'])) ? $info['address_id'] : null;
        $this->data['payment_method'] = (isset($info['payment_method'])) ? $info['payment_method'] : null;
        $this->data['amount'] = (isset($info['amount'])) ? $info['amount'] : null;
        $this->data['delievery_fee'] = (isset($info['delievery_fee'])) ? $info['delievery_fee'] : null;
        $this->data['offer_code'] = (isset($info['offer_code'])) ? $info['offer_code'] : null;
        $this->data['discount'] = (isset($info['discount'])) ? $info['discount'] : null;
        $this->data['grand_total'] = (isset($info['grand_total'])) ? $info['grand_total'] : null;
